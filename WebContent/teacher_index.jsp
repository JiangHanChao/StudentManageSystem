            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <!-- 任成琨修改部分，2018.12.9 -->
                        <span class="block m-t-xs"><strong class="font-bold">欢迎登录，${u_name}老师</strong></span>
                ...
                <li>
                    <a class="J_menuItem" href="teacher_show_course.jsp?u_number=${u_number }"><i class="fa fa-home"></i> <span class="nav-label">查询开设的课程</span></a>
                </li>

                <li>
                    <a class="J_menuItem" href="teacher_submit_grade.jsp?u_number=${u_number }"><i class="fa fa fa-bar-chart-o"></i> <span class="nav-label">提交成绩</span></a>
                </li>
